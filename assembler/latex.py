...
def _render_preamble() -> str:
    return "\n".join(
        [
            ...
            "\\usepackage[a4paper,inner=1.15in,outer=1.05in,top=1.1in,bottom=1.15in]{geometry}",
            "\\usepackage{setspace}",
            "\\usepackage{hyperref}",
            "\\usepackage{url}",
            "\\usepackage{xurl}",
            ...
            "",
            "% professional_book theme: restrained, print-friendly book palette",
            "\\definecolor{booktext}{RGB}{35,35,33}",
            "\\definecolor{bookaccent}{RGB}{45,62,91}",
            "\\definecolor{bookburgundy}{RGB}{105,54,62}",
            "\\definecolor{bookgreen}{RGB}{64,86,70}",
            "\\definecolor{bookrule}{RGB}{168,162,150}",
            "\\definecolor{booktint}{RGB}{248,246,241}",
            "\\definecolor{bookbluegray}{RGB}{239,243,246}",
            "\\definecolor{bookcaution}{RGB}{250,245,242}",
            "\\color{booktext}",
            "\\addtokomafont{chapter}{\\color{bookaccent}\\rmfamily}",
            "\\addtokomafont{section}{\\color{bookaccent}\\rmfamily}",
            "\\addtokomafont{subsection}{\\color{bookburgundy}\\rmfamily}",
            "\\hypersetup{colorlinks=true,linkcolor=bookaccent,urlcolor=bookaccent,citecolor=bookgreen}",
            ...
            "\\definecolor{codeframe}{RGB}{185,181,171}",
            "\\definecolor{codecomment}{RGB}{93,111,91}",
            "\\definecolor{codestring}{RGB}{119,73,78}",
            "\\definecolor{codekeyword}{RGB}{45,62,91}",
            "",
            ...
            "",
            "% Subtle textbook-style callouts",
            "\\newtcolorbox{diagramplaceholder}[2][]{",
            "  colback=bookbluegray,",
            "  colframe=bookrule,",
            "  title={#2},",
            "  fonttitle=\\bfseries\\color{bookaccent},",
            "  boxrule=0.4pt,",
            "  arc=1pt,",
            "  #1",
            "}",
            ...
            "  fonttitle=\\bfseries\\color{bookgreen},",
            "  boxrule=0.4pt,",
            "  arc=1pt,",
            "  #1",
            "}",
            ...
            "  fonttitle=\\bfseries\\color{bookburgundy},",
            "  boxrule=0.4pt,",
            "  arc=1pt,",
            "  #1",
            "}",
...
def _render_tikz_diagram(elements: list[str], *, diagram_type: str) -> str:
    ...
    style = (
        "draw=bookrule, fill=white, rounded corners=1pt, "
    ...
    for index in range(min(len(elements[:9]) - 1, 8)):
        lines.append(f"\\draw[->, thick, bookaccent] (n{index}) -- (n{index + 1});")

    lines.extend(
        [
            "\\begin{scope}[on background layer]",
            "\\node[fill=bookbluegray, rounded corners=1pt, fit=(n0) (n"
